...
/**
 * MybatisPlusAdapter is the MybatisPlus adapter for jCasbin.
 * It can load policy from MybatisPlus supported database or save policy to it.
 */
public class MybatisPlusAdapter implements Adapter, BatchAdapter {
    ...
    /**
     * MybatisPlusAdapter is the constructor for MybatisPlusAdapter.
     *
     ...
     */
    public MybatisPlusAdapter(String driver, String url, String username, String password) {
        this.driver = driver;
        this.url = url;
     ...
     */
    public MybatisPlusAdapter(String driver, String url, String username, String password, boolean dbSpecified) {
        this.driver = driver;
        this.url = url;
        this.username = username;
        this.password = password;
    ...
    private SqlSessionFactory initSqlSessionFactory(DataSource dataSource){
        ...
        //Register a MybatisPlus context alias
